介绍 说明 概念 
  PS：PHP,全称:Hypertext Preprocessor,超文本预处理器,
    是一种创建动态交互性站点的服务器端脚本语言;
    HTML和js是客户端语言,用于实现页面呈现、特效,服务器端脚本语言:用于从服务器端的存取;
  功能
    能够生成动态页面内容,
  ...
  说明
    PS：脚本可以放在文档中的任何位置,以 <?php 开头,以?>结尾;
...
语句 
  PS：语句间使用分号;分割,且不可省略
  echo 和 print 浏览器输出文本
    区别:
      echo  可以输出一个或多个字符串
      print 只允许输出一个字符串,返回值总为 1
      echo 输出的速度比 print 快,
      echo 没有返回值,print有返回值 1
    echo
